...
$geometry->addFace(new Vec3(0,1,2));
$geometry->addFace(new Vec3(0,2,3));
$geometry->addFace(new Vec3(1,2,3));

$mesh = new Mesh($geometry, '#');
$scene->addMesh($mesh);

$camera = new Camera(new Vec3(0,0,-5), 133/2, 239/2, 3, 30/2, false);
